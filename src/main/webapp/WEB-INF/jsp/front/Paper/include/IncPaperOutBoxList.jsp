...
<%@ page import="com.emfldlem.Common.DateUtility" %>
...
<table class="table table-hover table-striped">
    ...
    <tr>
        ...
        <td class="mailbox-subject" >
            <a href="/paper/getOutBoxPaperDetail?paper_no=<%=paperMgmt.getPaperNo()%>" data-paperno="<%=paperMgmt.getPaperNo()%>"><%=paperMgmt.getPaperTitle()%></a>
        </td>
        <td>
            <%=paperSateNm%>
        </td>
