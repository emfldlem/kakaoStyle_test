...
public class NumberUtility {
     ...
     */
    public String notation(double dbl) {
     ...
     */
    public double normal(String str) {
        double returnValue;
     ...
     * @return
     */
    public double ceil(double dbl, int range) {
     ...
     * @return
     */
    public double floor(double dbl, int range) {
     ...
     * @return
     */
    public double round(double dbl, int range) {
        return Math.round(dbl / range) * range * 1.0d;
    }
     ...
     * @return double
     */
    public double ceilPoint(double number, int scale) {
     ...
     * @return double
     */
    public double floorPoint(double number, int scale) {
        BigDecimal bigDecimal = BigDecimal.valueOf(number);
     ...
     * @return double
     */
    public double roundPoint(double number, int scale) {
        BigDecimal bigDecimal = BigDecimal.valueOf(number);
